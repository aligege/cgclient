...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent*)event{
    ...
    for (UITouch *touch in touches) {
        ...
        cg::Engine::systemTouchStart(identifier, point.x, point.y);
    }
}
...
- (void)touchesMoved:(NSSet<UITouch *> *)touches withEvent:(UIEvent*)event{
    ...
    for (UITouch *touch in touches) {
        const CGPoint point = [self getTouchPoint:touch];
        const int identifier = (int)[self getTouchId:touch];
        cg::Engine::systemTouchMove(identifier, point.x, point.y);
    }
}
...
- (void)touchesEnded:(NSSet<UITouch *> *)touches withEvent:(UIEvent*)event{
    ...
    for (UITouch *touch in touches) {
        ...
        cg::Engine::systemTouchEnd(identifier, point.x, point.y);
    }
}
